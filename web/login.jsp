					...
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
						 ...
						 <form action="login1.jsp" method="post">            
                               ...
                               <tr>
                                   <tr><td style="color: white;width: 200px;font-family:Lucida Handwriting;font-size: 20px"><b>Name:</b></label></td>
                                   <td><input style="width:250px; height:50px" type="text" placeholder="Enter Name" name="name" required></td> 
                               </tr></br>
                               <tr>
                                   <tr><td style="color: white;width: 200px;font-family:Lucida Handwriting;font-size: 20px"><b>Password:</b></label></td>
